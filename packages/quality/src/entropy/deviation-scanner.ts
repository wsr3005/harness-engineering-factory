...
const isDomainFile = (filePath: string): boolean => /\/domains\/[^/]+\//.test(toPosix(filePath));

const domainNameFromPath = (filePath: string): string | null => {
...
const walkTsFiles = async (rootDir: string): Promise<string[]> => {
